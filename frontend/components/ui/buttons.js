 ...
 */
export function IconButton({ label, id = '', iconSvg, color = 'primary' }) {
  ...
  return `
    <button id="${id}" class="flex flex-col items-center justify-center p-4 rounded-lg border border-border transition-all group ${colorClasses.wrapper} focus:outline-none">
